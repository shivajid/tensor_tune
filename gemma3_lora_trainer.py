...
print("Welcome to Gemma3 4B LoRA Tuning")
print("== Ready for the Fun Gemma3 LoRA Training ===")
...
# Training with full weights (commented out)
...
with jax.profiler.trace(os.path.join(PROFILING_DIR, "full_training_gemma3")):
    with mesh:
...
with jax.profiler.trace(os.path.join(PROFILING_DIR, "peft_gemma3")):
    with mesh:
