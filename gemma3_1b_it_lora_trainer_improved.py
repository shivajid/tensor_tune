...
print("Welcome to Improved Gemma3 1B IT LoRA Tuning")
...
MAX_STEPS = 500  # Increased from 500
...
CKPT_DIR = "/home/shivajid/gemma3/improved/1b-it/ckpts/"
...
if not os.path.exists(checkpoint_path):
    print(f"Existing checkpoint directory: {checkpoint_path}")
...
def get_base_model(ckpt_path):
    """Load the base Gemma3 1B model from checkpoint."""
    model_config = gemma3_lib.Gemma3Config.gemma3_1b()
...
input_batch = [
    "Tell me a story of cow and squirrel",
    prompt_format("Translate this into French:\nHello, my name is Morgane.\n"),
...
# Optimized learning rate schedule for Gemma3 1B
def create_optimizer():
    """Create an optimized learning rate schedule for Gemma3 1B."""
